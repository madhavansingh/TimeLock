...
const codeExamples = [
  {
    label: "Install",
    code: `npm install @timelock/sdk
 
# or
yarn add @timelock/sdk
pnpm add @timelock/sdk`,
  },
  {
    label: "Initialize",
    code: `import { TimeLock } from '@timelock/sdk'
 
const timelock = new TimeLock({
  apiKey: process.env.TIMELOCK_KEY
})`,
  },
  {
    label: "Anchor",
    code: `const doc = await timelock.anchor({
  title: 'Sale Deed - Plot 42',
  type: 'Sale Deed',
  file: documentBuffer,
  notaryId: 'rao-notary-id'
})
 
console.log('Anchored at Tx:', doc.txSignature)`,
  },
];
