...
const features = [
  {
    number: "01",
    title: "Solana Trust Anchor",
    description: "Derived on-chain Program Derived Addresses (PDAs) lock document SHA-256 fingerprints with absolute cryptographic timestamp proof, ensuring unbackdatable registry records.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Notary Digital Verification",
    description: "Simulate and verify digital signatures securely with Class-3 DSC credentials, linking public notary identities to document integrity on-chain.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Real-Time Tamper Detection",
    description: "Upload scans and instantly check if any clause, parameter, or value has been modified. In-browser hashing checks remote registry entries in seconds.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Court-Ready Audit Trails",
    description: "Generate Section 65B-compliant verification certificates and view comprehensive custody timelines tracing from citizen uploads to bank inspections.",
    visual: "security",
  },
];
